			...
			for (int i = 1; i < 26; i++) {
				...
				if (serviceid.equals("PR")) {
					try {
						...
						wait1.until(ExpectedConditions.visibilityOfElementLocated(By.id("chkPR")));
				...
				// If match with S2, below code will execute
					...
					try {
						...
						WebDriverWait wait1 = new WebDriverWait(driver, 120);
						wait1.until(ExpectedConditions.visibilityOfElementLocated(By.id("chkS2")));
					...
					try {
						...
						WebDriverWait wait1 = new WebDriverWait(driver, 120);
						wait1.until(ExpectedConditions.visibilityOfElementLocated(By.id("chkDR")));
					...
					try {
						...
						WebDriverWait wait1 = new WebDriverWait(driver, 120);
						wait1.until(ExpectedConditions.visibilityOfElementLocated(By.id("chkDRV")));
					...
					try {
						...
						WebDriverWait wait1 = new WebDriverWait(driver, 120);
						wait1.until(ExpectedConditions.visibilityOfElementLocated(By.id("chkAIR")));
					...
					try {
						...
						WebDriverWait wait1 = new WebDriverWait(driver, 120);
						wait1.until(ExpectedConditions.visibilityOfElementLocated(By.id("chkSDC")));
					...
					try {
						...
						WebDriverWait wait1 = new WebDriverWait(driver, 120);
						wait1.until(ExpectedConditions.visibilityOfElementLocated(By.id("chkFRG")));
