	...
	public static void addressImport() throws InterruptedException, IOException {
		...
		for (int i = 0; i < 5; i++) {
			...
			if (i == 0) {
				...
				FileUtils.copyFile(scrFile, new File(".\\src\\main\\resources\\TestFiles\\AddressImport.png"));
				...
				File scrFile = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
				FileUtils.copyFile(scrFile, new File(".\\src\\main\\resources\\Screenshots\\AddressImport01.png"));

				driver.findElement(By.id("cmdUpload")).click();
				Thread.sleep(5000);

				File scrFile1 = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
				FileUtils.copyFile(scrFile1, new File(".\\src\\main\\resources\\Screenshots\\AddressImport02.png"));
				Thread.sleep(3000);
				driver.findElement(By.id("cmdProcess")).click();
