...
public class CustomDataDownload extends BaseClass {
	...
	public static void newReport() throws Exception {
		...
		FileUtils.copyFile(scrFile, new File(".\\src\\main\\resources\\Screenshots\\CustomDataDownload.png"));
	...
	public static void allColumns() throws Exception {
		...
		Thread.sleep(5000);
		File scrFile = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(scrFile, new File(".\\src\\main\\resources\\Screenshots\\CustomDataDownload_AllColumns.png"));
